...
vim.keymap.set("n", "<leader>omp", function()
  util.notes.move_note("projects")
end, { desc = "move note to projects" })
vim.keymap.set("n", "<leader>oma", function()
  util.notes.move_note("areas")
end, { desc = "move note to areas" })
vim.keymap.set("n", "<leader>omr", function()
  util.notes.move_note("resources")
end, { desc = "move note to resources" })
